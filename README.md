...
>
> Cada proyecto recibe un presupuesto personalizado según su complejidad.

---

# 🖌️ | Diseño de servidores Discord
...
Todo lo incluido en el plan Básico, además de:
...
Todo lo incluido en Standard, además de:
...
# 🛠️ | Optimización de servidores

¿Ya tienes un servidor pero quieres mejorar su organización, seguridad o funcionalidad?
...
# ⚙️ | Configuración y automatización de bots

Compatible con bots como:
...
Todos los bots se desarrollan específicamente para las necesidades del cliente.
...
Hasta **6 sistemas personalizados**.
...
Pensado para proyectos profesionales.
...
# 🛡️ | Moderación de comunidades

Servicio de moderación para comunidades de Discord.
...
### ¿La garantía incluye nuevas funciones?

No.

La garantía únicamente cubre errores relacionados con el desarrollo entregado.

---

### ¿Se entrega el código fuente?

Dependerá del tipo de proyecto y del presupuesto acordado.
